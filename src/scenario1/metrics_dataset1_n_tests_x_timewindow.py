...
import json
from deep_learning_larcc.utils import simple_metrics_calc
import numpy as np
...
if __name__ == '__main__':
    ...
    for x_time in x_times:
        cnn_model = "v1_1"
        json_file = "100_times_train_test_cnn_"+cnn_model+"_time_window_"+str(x_time)+"_ts.json"
        ...
        if isinstance(data, list) and data:
            ...
            with open("statistical_metrics_100_dataset1_" + cnn_model+"_time_window_"+str(x_time)+"_ts.json", "w") as write_file:
